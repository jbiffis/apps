...
import { Home, Plus, Stats, User, Sun, Sleep, Pill, Water, DynamicIcon } from './icons/index.jsx'

// Epic 5 placeholder. Proves the design tokens, typography, icon set and
// light/dark switching all work end-to-end. Real screens (Login, Home, Entry,
// History) replace this in Epics 6+.
    ...
    <div className="mx-auto flex min-h-full max-w-[480px] flex-col bg-bg">
      ...
      <header className="flex items-center justify-between px-[18px] pb-2.5 pt-2">
        <div>
          ...
          <h1 className="font-display text-[22px] font-extrabold text-ink">Good morning.</h1>
        </div>
        <button
          onClick={cycleTheme}
